...
<div align="center">
    <img alt="GitHub Release" src="https://img.shields.io/github/v/release/kevin.tomlinson/jellyfin-plugin-letterboxd-sync">
    <img alt="GitHub Downloads (all assets, latest release)" src="https://img.shields.io/github/downloads/kevin-tomlinson/jellyfin-plugin-letterboxd-sync/latest/total">
</div>
...
```
https://raw.githubusercontent.com/kevin-tomlinson/jellyfin-plugin-letterboxd-sync/master/manifest.json
```
